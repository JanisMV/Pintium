...
import fr.janis.pintium.gui.slot.PintiumResultSlot;
...
public class ExtractorMachineMenu extends AbstractContainerMenu {
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, PintiumBlocks.EXTRACTOR_MACHINE_BLOCK.get());
    }
