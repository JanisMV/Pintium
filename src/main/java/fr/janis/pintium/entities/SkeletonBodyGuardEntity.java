...
public class SkeletonBodyGuardEntity extends SkeletonEntity {

    public SkeletonBodyGuardEntity(EntityType<? extends SkeletonEntity> type, World worldIn) {
        super(type, worldIn);
    }
    ...
    protected void playStepSound(BlockPos pos, BlockState blockIn) {
        super.playSound(SoundEvents.SKELETON_STEP, 0.15F, 1.0F);
    }
